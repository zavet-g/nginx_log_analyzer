...
from apps.api.v1.schemas.analytics_schema import ErrorStats
from apps.api.v1.schemas.analytics_schema import StatusCodeStats
from apps.api.v1.schemas.analytics_schema import TimeSeriesData
from apps.api.v1.schemas.analytics_schema import TopIPsStats
from apps.api.v1.schemas.analytics_schema import TopURLsStats
from apps.api.v1.schemas.analytics_schema import TrafficStats
...
class TestAnalyticsSchemas:
    ...
    def test_top_ips_stats_schema(self):
        ...
        data = {'ip': '192.168.1.100', 'requests': 50, 'avg_size': 1024}
    ...
    def test_top_urls_stats_schema(self):
        ...
        data = {'url': '/api/users', 'requests': 25, 'avg_size': 2048}
    ...
    def test_error_stats_schema_without_user_agent(self):
        ...
        timestamp = datetime.now(UTC)
        data = {'status': 500, 'url': '/api/orders', 'ip': '192.168.1.101', 'timestamp': timestamp}
    ...
    def test_time_series_data_schema(self):
        ...
        timestamp = datetime.now(UTC)
        data = {'timestamp': timestamp, 'requests': 100, 'bytes': 51200}
    ...
    def test_schemas_validation(self):
        """Тест валидации схем."""
        valid_data = {'status': 200, 'count': 100}
    ...
    def test_schemas_serialization(self):
        ...
        time_series = TimeSeriesData(timestamp=timestamp, requests=100, bytes=51200)

        assert status_stats.model_dump() == {'status': 200, 'count': 100}
        assert top_ips.model_dump() == {'ip': '192.168.1.100', 'requests': 50, 'avg_size': 1024}
        ...
        assert time_series.model_dump() == {'timestamp': timestamp, 'requests': 100, 'bytes': 51200}
    ...
    def test_schemas_inheritance(self):
        ...
        assert TopIPsStats.model_validate({'ip': '192.168.1.100', 'requests': 50, 'avg_size': 1024})
